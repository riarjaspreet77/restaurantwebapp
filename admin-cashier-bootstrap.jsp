...
<%@ include file="bootstrap_header-admin-cashier.jsp" %>
  </div>
...
try {
	...
	while (rs.next())
		{  
		    ...
		    %>
		   <div class="button"> <form action="category_type_admin" method="post" >
...
try {
	...
	while (rs.next())
		{  
		  ...
		  <form action="quantity_update_admin" method="post">
...
try {
  ...
  <%
	...
	<div class="total-print">
	  <form action="clear_cart_admin" method="post">
