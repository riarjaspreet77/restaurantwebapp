...
<nav class="navbar  navbar-custom navbar-fixed-top">
  ...
  <div class="container-fluid">
    ...
    <h4 class="navbar-text" id="title">Made with Love <span class="glyphicon glyphicon-heart" style=color:red;></span></h4>
        ...
        <li><a href="admin-tables-bootstrap.jsp" class="navbar-brand" id="table"><strong>Tables</strong></a>
       <a href="admin-bootstrap.jsp" class="navbar-brand" id="home" ><strong>Home</strong></a>
        </li>
        </ul>     
                </div>
         
     <div class="nav navbar-nav navbar-right">
      <h3 class="txt-header">welcome Admin:<%=employ_id%></h3>
