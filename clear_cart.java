...
public class clear_cart extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// inserting value 
			stm.executeUpdate("insert into master_table(employ_id,table_no_1,item_name_1,item_price_1,quantity,total) SELECT employ_id,table_no,item_name,item_price,quantity,total FROM customer_data where table_no='"+table_number_1+"' ");
